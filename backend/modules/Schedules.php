 ...
 */
class Schedules extends Lib\Base\Component {
    protected static $pageSlug = 'connectpx_booking_schedules';
    ...
    {
        $datatables = Lib\Utils\Tables::getSettings( 'schedules' );

        wp_localize_script( 'connectpx_booking_schedules', 'ConnectpxBookingL10n', array(
            ...
            'zeroRecords'     => __( 'No schedules for selected period.', 'connectpx_booking' ),
        ...
        wp_enqueue_script('connectpx_booking_schedules');
        ...
        self::renderTemplate( 'backend/templates/schedules', compact( 'customers', 'services', 'datatables' ) );
    }
}
