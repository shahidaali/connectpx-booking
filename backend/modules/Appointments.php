 ...
 */
class Appointments extends Lib\Base\Component {
    protected static $pageSlug = 'connectpx_booking_appointments';
    ...
    public static function render()
    {
        ...
        wp_localize_script( 'connectpx_booking_appointments', 'ConnectpxBookingL10n', array(
            ...
            'zeroRecords'     => __( 'No appointments for selected period.', 'connectpx_booking' ),
        ...
        wp_enqueue_script('connectpx_booking_appointments');
        ...
        self::renderTemplate( 'backend/templates/appointments', compact( 'customers', 'services', 'datatables' ) );
    }
}
