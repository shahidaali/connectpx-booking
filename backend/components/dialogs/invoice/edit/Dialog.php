...
class Dialog extends Lib\Base\Component
{
    ...
    {
        wp_enqueue_script('connectpx_booking_invoice_edit');

        wp_localize_script( 'connectpx_booking_invoice_edit', 'ConnectpxBookingL10nAppDialog', array(
        ...
        self::renderTemplate( 'backend/components/dialogs/invoice/edit/templates/edit');
    }
}