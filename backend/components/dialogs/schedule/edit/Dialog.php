...
{
    /**
     * Render create/edit schedule dialog.
     * @param bool $show_wp_users
     */
    public static function render( $show_wp_users = true )
    {
        wp_enqueue_script('connectpx_booking_schedules_edit');
        ...
        wp_localize_script( 'connectpx_booking_schedules_edit', 'ConnectpxBookingL10nAppDialog', array(
            ...
            'addons' => array(),
            'send_notifications' => (int) get_user_meta( get_current_user_id(), 'connectpx_booking_schedule_form_send_notifications', true ),
            'appropriate_slots' => get_option( 'connectpx_booking_schedules_displayed_time_slots', 'all' ) === 'appropriate',
            'service_main' => get_option( 'connectpx_booking_schedules_main_value', 'all' ) === 'service',
            'l10n' => array(
                'edit_schedule' => __( 'Edit schedule', 'connectpx_booking' ),
                'new_schedule' => __( 'New schedule', 'connectpx_booking' ),
                ...
                'chose_queue_type_info' =>  __( 'If you have added a new customer to this schedule or changed the schedule status for an existing customer, and for these records you want the corresponding email or SMS notifications to be sent to their recipients, select the "Send if new or status changed" option before clicking Send. You can also send notifications as if all customers were added as new by selecting "Send as for new".', 'connectpx_booking' ),
                ...
                'notices' => array(
                    ...
                    'date_interval_not_available' => __( 'The selected period is occupied by another schedule', 'connectpx_booking' ),
        ...
        self::renderTemplate( 'backend/components/dialogs/schedule/edit/templates/edit', compact( 'show_wp_users', 'statuses' ) );
    }
}