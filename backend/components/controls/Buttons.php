...
class Buttons
{
     ...
     * @param bool $ellipsis
     */
    public static function renderAdd( $id = 'connectpx_booking-add', $extra_class = null, $caption = null, array $attrs = array(), $ellipsis = true )
    {
        echo self::_createButton(
            'button',
            $id,
            ...
            $extra_class,
            $attrs,
            $caption !== null ? $caption : __( 'Add', 'connectpx_booking' ),
            '{caption}' . ( $ellipsis ? '…' : '' ),
     ...
     * @param bool $ellipsis
     */
    public static function renderDelete( $id = 'connectpx_booking-delete', $extra_class = null, $caption = null, array $attrs = array(), $ellipsis = true )
    {
        echo self::_createButton(
            'button',
            $id,
            ...
            $extra_class,
            $attrs,
            $caption !== null ? $caption : __( 'Delete', 'connectpx_booking' ),
            '{caption}' . ( $ellipsis ? '…' : '' ),
    ...
    public static function renderReset( $id = null, $extra_class = null, $caption = null, array $attrs = array(), $ellipsis = false )
    {
        echo self::_createButton(
            ...
            $extra_class,
            $attrs,
            $caption !== null ? $caption : __( 'Reset', 'connectpx_booking' ),
            '{caption}' . ( $ellipsis ? '…' : '' )
        );
    }
    ...
    {
        $attrs += array( 'data-dismiss' => 'connectpx_booking-modal' );
        echo self::_createButton(
            'button',
            null,
            'btn-default',
     ...
     * @param bool $ellipsis
     */
    public static function renderSubmit( $id = 'connectpx_booking-save', $extra_class = null, $caption = null, array $attrs = array(), $ellipsis = false )
    {
        echo self::_createButton(
            'submit',
            $id,
            ...
            $extra_class,
            $attrs,
            $caption !== null ? $caption : __( 'Save', 'connectpx_booking' ),
            '{caption}' . ( $ellipsis ? '…' : '' )
        );
    }
