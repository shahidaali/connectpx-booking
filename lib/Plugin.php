...
class Plugin {
	...
	public static function globalScripts() {
		...
		// Appointment Dialog
		wp_register_script( 
			'connectpx_booking_schedules_edit', 
			$admin_resources . 'components/dialogs/schedule/edit/resources/js/schedule_edit.js', 
			array( 
				'jquery', 
				'connectpx_booking_global',
				'connectpx_booking_bootstrap',
		...
		// Invoice View Dialog
		wp_register_script( 
			'connectpx_booking_invoice_view', 
			$admin_resources . 'components/dialogs/invoice/view/resources/js/invoice_view.js', 
			array( 
				'jquery', 
				'connectpx_booking_global',
				'connectpx_booking_bootstrap',
